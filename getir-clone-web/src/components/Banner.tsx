...
const ImageContainer: React.FunctionComponent<{
  url: string;
  alt?: string;
}> = ({ url, alt }) => {
  return (
...
export default function Banner() {
  ...
  return (
    ...
    >
      <ImageContainer
        url={"https://www.themanan.me/images/carousel/istanbul-0.jpg"}
        alt={"banner"}
      />
      <Box
        position={"absolute"}
      ...
      >
        ...
        >
          <Box fontSize={"2xl"}>
            <Heading as={"h1"}>Getirbüyük</Heading>
